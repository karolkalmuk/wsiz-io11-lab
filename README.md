...
Implementacja metod `info` i `error` powinna polegać na wykonaniu korespondującej metody na przesłanych uprzednio obiektach typu `Logger`, klasa ta powinna pełnić jedynie rolę pośrednika.